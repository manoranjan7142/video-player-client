...
useEffect(() => {
  function start(){
    gapi.client.init({
      clientId: "209844895475-9cu7vp191q860enfhdmesrvumieu1mk2.apps.googleusercontent.com",
      scope: "email",
    });
  }
    ...
    <div className="Container_Navbar">
       ...
       <div className="Auth_cont_Navbar">
        {CurrentUser? (
         ...
         <GoogleLogin 
          clientId={
            "209844895475-9cu7vp191q860enfhdmesrvumieu1mk2.apps.googleusercontent.com"
          }
          onSuccess={onSuccess}
          onFailure={onFailure}
          render={(renderProps) => (
